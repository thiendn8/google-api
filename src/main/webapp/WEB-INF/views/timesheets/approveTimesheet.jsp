...
<html>
<head>
    <title>Approve request timesheet</title>
...
<div class="container">
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-md-6">
                <h3 class="color-scrum">Approve request</h3>
            </div>
        </div>
        <c:if test="${not empty listMyRequest}">
            <table class="table-bordered">
                ...
                <tr class="row">
                    ...
                    <th class="col-md-1">Time Offset</th>
                ...
                <c:forEach items="${listMyRequest}" var="listMyRequest">
                    <tr class="row">
                        ...
                        <td class="col-md-1"><c:out value="${listMyRequest.timeOffset} (h)"/></td>
                        <td class="col-md-1">
                            <span data-toggle="tooltip" data-placement="bottom" class="ellipsisText" title="${listMyRequest.reasonRequest}">
                        ...
                        <td class="col-md-1">
                            <c:if test="${listMyRequest.status == 'Pending'}">
                                <a href="/processApproved?indexRequest=${listMyRequest.id}">Approve</a>
                            </c:if>
                           <c:if test="${listMyRequest.status == 'Approved'}">Approved</c:if>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
